...
HELP="apidiff build check-commit check-deps gcpmaster ggi inspect lint scandeps scan-imports scaninfo scansymbols scan-packages wizard tools pull push scratch-build bbo"
rm -f tools.options
for cmd in $HELP; do
